...
\veryHuge \color{NavyBlue} \textbf{A data-driven approach for the analysis \\of SARS-CoV-2 mutations}\\[1cm] % Subtitle
\huge \textbf{Samuele Del Bello, Stefano Destro, Alessio Frezza, \\Rita Numeroli, Carlos Santillán}\\ % Author(s)
\huge Supervisor: Pietro Pinoli PhD.\ % University/organization
\end{minipage}
%
...
\begin{center}\vspace{1cm}
	...
	\captionof{figure}{Pairs plot colored by cluster}
	\includegraphics[width=170mm, height=80mm]{dendrogram.png}
	\captionof{figure}{Dendrogram for AY.103 with Ward's linkage}
\end{center}\vspace{1cm}
...
\begin{center}\vspace{1cm}
	...
	\captionof{figure}{AY.103 mutation frequency barplot comparison}
\end{center}\vspace{1cm}
...
\begin{center}\vspace{1cm}
	...
	\begin{tabular}{l l }
		...
		\bottomrule
	\end{tabular}
	\captionof{table}{Lineage - clade table}
\end{center}\vspace{1cm}
...
\begin{center}\vspace{1cm}
	...
	\captionof{figure}{Pairs plot colored by cluster (same as clade)}
\end{center}\vspace{1cm}
